...
console.log(`구분자 : ${path.sep}`); // 구분자는 OS마다 다르기 때문에 폴더나 파일 경로를 사용할 때 path.sep을 사용해줘야 한다.
...
console.log(path.join(__dirname, 'source')); // 사용하자.
console.log(path.join(__dirname, 'app.js')); // 사용하자.
//console.log(__dirname+'/node'); // 사용하지 마라